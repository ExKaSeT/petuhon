from PyQt5.QtWidgets import QApplication, QMainWindow, QTextEdit, QWidget, QPushButton, QLabel, QWidget, QCheckBox, QVBoxLayout, QButtonGroup,QRadioButton
import pygame
from tkinter import *
