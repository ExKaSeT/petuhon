...
from PyQt5.QtWidgets import QApplication, QMainWindow, QTextEdit, QWidget, QPushButton, QLabel, QWidget, QCheckBox, \
...
class Window1(QWidget):
    def init(self):
        ...
        # Создаем объект QLabel и устанавливаем на него изображение
        label = QLabel(self)
        ...
        # layout = QVBoxLayout()
        layout.addWidget(self.butt1)
        self.butt2 = QRadioButton("may 2023")
        # layout = QVBoxLayout()
        layout.addWidget(self.butt2)
        layout.setAlignment(Qt.AlignBottom | Qt.AlignHCenter)
        layout.setSpacing(60)
        # Устанавливаем QVBoxLayout на QWidget
        self.setLayout(layout)
    def show_window_2(self):
        #self.w2 = Window2()
        #self.w2.show() global tp
...
if __name__ == "__main__":
    ...
    w.button.clicked.connect(w.show_window_2)
